...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger); //console.log(SplitText);
//////////// ANIMATIONS

if (document.fonts) {
  var split = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText('.head__title--big', {
    type: 'chars'
  });
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from('.head__title--small', {
    opacity: 0,
    delay: 1.5,
    duration: 0.8,
    ease: 'power2.out'
...
var splitIntro = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText('.intro__text', {
  type: 'words'
});
var splitIntroDesk = new gsap_SplitText__WEBPACK_IMPORTED_MODULE_1__.SplitText('.intro__text', {
  type: 'lines'
});

if (window.innerWidth < 768) {
  if (introText) {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(splitIntro.words, {
      scrollTrigger: {
        trigger: '.intro',
        start: 'top 80%',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from('.intro__text--mark', {
    scrollTrigger: {
      trigger: 'intro',
      start: 'top 50%',
      toggleActions: 'play none none reverse'
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(splitIntroDesk.lines, {
    scrollTrigger: {
      trigger: '.intro',
      start: 'top 50%',
      toggleActions: 'play none none reverse'
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from('.tda__content--card', {
  scrollTrigger: {
